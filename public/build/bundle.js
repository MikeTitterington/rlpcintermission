...
var app = (function () {
    ...
    // (48:4) {#each tonightGames as game (game.time)}
    function create_each_block$2(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(48:4) {#each tonightGames as game (game.time)}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$5, 72, 8, 2576);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "left bar");
    			attr_dev(img, "class", "svelte-la8n1h");
    			add_location(img, file$5, 53, 8, 1739);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    			insert_dev(target, t0, anchor);
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(iframe, file$5, 75, 16, 2708);
    			attr_dev(div, "class", "desk2 svelte-la8n1h");
    			add_location(div, file$5, 74, 12, 2671);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, iframe);
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(iframe, "frameborder", "0");
    			attr_dev(iframe, "class", "svelte-la8n1h");
    			add_location(iframe, file$5, 81, 16, 2971);
    			attr_dev(div, "class", "anal12 svelte-la8n1h");
    			add_location(div, file$5, 80, 12, 2933);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, iframe);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(80:8) {#if anal1Video != 'null'}",
    		ctx
    	});
    ...
    function create_if_block_3$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(iframe, "frameborder", "0");
    			attr_dev(iframe, "class", "svelte-la8n1h");
    			add_location(iframe, file$5, 56, 16, 1870);
    			attr_dev(div, "class", "desk svelte-la8n1h");
    			add_location(div, file$5, 55, 12, 1834);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, iframe);
    ...
    function create_if_block_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(iframe, "frameborder", "0");
    			attr_dev(iframe, "class", "svelte-la8n1h");
    			add_location(iframe, file$5, 62, 16, 2132);
    			attr_dev(div, "class", "anal1 svelte-la8n1h");
    			add_location(div, file$5, 61, 12, 2095);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, iframe);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(61:8) {#if anal1Video != 'null'}",
    		ctx
    	});
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(iframe, "frameborder", "0");
    			attr_dev(iframe, "class", "svelte-la8n1h");
    			add_location(iframe, file$5, 68, 16, 2387);
    			attr_dev(div, "class", "anal2 svelte-la8n1h");
    			add_location(div, file$5, 67, 12, 2350);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, iframe);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(67:8) {#if anal2Video != 'null'}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img1.src !== (img1_src_value = "assets\\Bottom_Ticker_Tape.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "ticker");
    			attr_dev(img1, "class", "svelte-la8n1h");
    			add_location(img1, file$5, 39, 4, 1142);
    			if (img2.src !== (img2_src_value = "assets\\RLPC_Desk_Bar.png")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "RLPC bar");
    			attr_dev(img2, "class", "svelte-la8n1h");
    			add_location(img2, file$5, 40, 4, 1203);
    			if (img3.src !== (img3_src_value = "assets\\Left_Red_Bar.png")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "left bar");
    			attr_dev(img3, "class", "svelte-la8n1h");
    			add_location(img3, file$5, 41, 4, 1261);
    			attr_dev(p0, "class", "rlpcDesk svelte-la8n1h");
    			add_location(p0, file$5, 43, 8, 1349);
    			attr_dev(p1, "class", "tonightDesk svelte-la8n1h");
    			add_location(p1, file$5, 44, 8, 1392);
    			attr_dev(div0, "class", "topLeft svelte-la8n1h");
    			add_location(div0, file$5, 42, 4, 1318);
    			if (img4.src !== (img4_src_value = "assets\\Todays_Matches_Bar.png")) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "alt", "left bar");
    			attr_dev(img4, "class", "svelte-la8n1h");
    			add_location(img4, file$5, 46, 4, 1452);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*tonightGames*/ 1) {
    				...
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context$2, get_key);
    				each_blocks = update_keyed_each(each_blocks, dirty, get_key, 1, ctx, each_value, each_1_lookup, div1, outro_and_destroy_block, create_each_block$2, t9, get_each_context$2);
    				check_outros();
    			}
