    ...
    {:else}
        {#if vidOption == 'on'}
            <div class='vid' transition:fade="{{ duration:1000, delay:2000, ease:'circ' }}">
                <iframe height='1015px' width='1598px' src="https://www.youtube.com/embed/rTQOqJhWoL0?controls=0&autoplay=1&vq=hd720&showinfo=0&loop=1&rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" muted></iframe>
            </div>
        {/if}
    {/if}
